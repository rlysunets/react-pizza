...
import { onPlus, onMinus, removeItem } from "../redux/slices/cartSlice"
...
const CartItem: FC<Props> = ({ id, name, price, type, size, imageUrl, count }) => {
      ...
      <>
         ...
         {isModal &&
            <Modal
               ...
               message={`Ви справді бажаєте видалити піцу "${name}" з корзини?`}
            />}
      </>
   )
}
