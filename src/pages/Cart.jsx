...
const Cart = () => {
   ...
   const onClearCart = () => {
      if (window.confirm("Ви точно бажаєте очистити корзину??")) {
         dispatch(clearCart())
      }
   }

   const onRemoveItem = (id) => {
      if (window.confirm("Ви точно бажаєте видалити піцу??")) {
   ...
   const onClickOrder = () => {
      ...
      alert("Ваше замовлення готується, очікуйте дзвінок від кур'єра!")
      dispatch(clearCart())
   }
