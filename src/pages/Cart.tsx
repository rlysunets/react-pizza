...
import { CartItem, CartEmpty, Modal, Order } from "../components"
      ...
      <>
            ...
            <div className="container container--cart">
               <div className="cart">
                  <div className="cart__top">
                     ...
                     <div className="cart__clear" onClick={onShowModal}>
         ...
         {isModal &&
            <Modal
               ...
               message="Ви точно бажаєте очистити корзину?"
            />}
         {isOrder && <Order onCloseOrder={onCloseOrder} totalPrice={totalPrice} />}
      </>
   )
}
